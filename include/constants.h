...
// Notcurses Flags
#define FLAGS (NCOPTION_SUPPRESS_BANNERS | NCOPTION_INHIBIT_SETLOCALE | NCOPTION_PRESERVE_CURSOR | NCOPTION_SCROLLING)

// main plain Flags
#define MAIN_PLAIN_FLAGS (NCPLANE_OPTION_VSCROLL )
